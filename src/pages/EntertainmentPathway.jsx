...
export default function EntertainmentPathway() {
  return (
    ...
    >
      <div className="absolute inset-0 z-0 bg-gradient-to-br from-dark-900 via-dark-900 to-[#101a1a] opacity-80" />
      ...
      <div className="relative z-10 w-full h-full flex flex-col lg:flex-row items-center justify-between">
        ...
        <div className="w-full lg:w-[45%] h-full flex flex-col justify-center px-8 md:px-16 lg:px-24 pt-32 pb-16 relative z-20">
          ...
          >
            Unrivaled <br />
            <span className="italic text-white/60">Entertainment.</span>
          </motion.h1>
          ...
          >
            Home to the World Waterpark, Galaxyland, and numerous record-breaking attractions. We blur the line between retail and recreation, driving industry-leading dwell times and transforming shopping into a true destination vacation.
          </motion.p>
          ...
          >
            <div>
              <p className="text-3xl font-display text-white mb-1">12+</p>
              <p className="text-[9px] uppercase tracking-widest text-white/40 font-semibold">Major Attractions</p>
            </div>
            <div className="w-[1px] h-12 bg-white/10" />
            <div>
              <p className="text-3xl font-display text-white mb-1">World's Largest</p>
              <p className="text-[9px] uppercase tracking-widest text-white/40 font-semibold">Indoor Wave Pool</p>
            </div>
          </motion.div>
        ...
        <div className="w-full lg:w-[55%] h-full relative">
          {/* User specifically asked for waterpark1, waterpark2, etc. here */}
          <FallbackImage 
      ...
      <div className="absolute inset-0 pointer-events-none z-30 overflow-hidden">
        <FallbackImage 
          src="/assets/waterpark1.png" 
          alt="Attractions Editorial 1" 
