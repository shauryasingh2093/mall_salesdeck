...
export default function HospitalityPathway() {
  return (
    <motion.main 
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      <div className="absolute inset-0 z-0 bg-gradient-to-br from-dark-900 via-dark-900 to-[#121620] opacity-80" />
      ...
      <div className="relative z-10 w-full h-full flex flex-col lg:flex-row items-center justify-between">
        ...
        <div className="w-full lg:w-[45%] h-full flex flex-col justify-center px-8 md:px-16 lg:px-24 pt-32 pb-16 relative z-20">
          ...
          >
            Stay Where <br />
            <span className="italic text-white/60">You Play.</span>
          </motion.h1>
          ...
          >
            Fantasyland Hotel offers a luxury hospitality experience seamlessly integrated into the retail ecosystem. This unparalleled convenience drives immense multi-day dwell times and transforms WEM from a shopping trip into a full vacation destination.
          </motion.p>
          ...
          >
            <div>
              <p className="text-3xl font-display text-white mb-1">355</p>
              <p className="text-[9px] uppercase tracking-widest text-white/40 font-semibold">Luxury Rooms</p>
            </div>
            <div className="w-[1px] h-12 bg-white/10" />
            <div>
              <p className="text-3xl font-display text-white mb-1">120</p>
              <p className="text-[9px] uppercase tracking-widest text-white/40 font-semibold">Themed Suites</p>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <p className="text-white/30 text-[9px] font-bold tracking-[0.3em] uppercase mb-4">On-Site Hotels</p>
            <div className="flex flex-wrap gap-2">
              {[
                { name: 'Fantasyland Hotel', desc: '120 Themed Suites + Standard Rooms' },
                { name: 'WEM Inn', desc: 'Comfortable Stay with Attraction Access' },
              ].map(({ name, desc }) => (
                <div key={name} className="px-4 py-2 border border-white/15 bg-white/5 hover:border-gold-500/40 transition-colors duration-300 cursor-hover">
          ...
          >
            <p className="text-white/30 text-[9px] font-bold tracking-[0.3em] uppercase mb-4">Premium Guest Services</p>
            <div className="flex flex-wrap gap-2">
              {['Valet Parking', 'WEM Card', 'Personal Styling', 'Guest Services'].map(s => (
                <span key={s} className="px-3 py-1 rounded-full text-[10px] text-white/70 border border-white/15 bg-white/5 tracking-wide">
                  {s}
                </span>
              ))}
            </div>
      ...
      <div className="absolute inset-0 pointer-events-none z-30 overflow-hidden">
        <FallbackImage 
          src="/assets/night_exterior.png" 
          alt="Hotel Editorial 1" 
